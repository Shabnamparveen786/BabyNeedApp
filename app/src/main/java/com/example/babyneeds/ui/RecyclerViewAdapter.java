...
public class RecyclerViewAdapter extends Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public RecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list1_row,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull RecyclerViewAdapter.ViewHolder viewHolder, int position) {
        ...
        viewHolder.itemName.setText(MessageFormat.format("Item:{0} ", item.getItamName()));
     ...
     public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public ViewHolder(@NonNull View itemView,Context ctx) {
         ...
         private void deleteItem(final int id) {
            ...
            Button yeesButton = view.findViewById(R.id.conf_yes_button);

            builder.setView(view);
            dialog = builder.create();
            dialog.show();
            yeesButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
         ...
         private void editItem(final Item newItem) {
           ...
           //final Item item = itemList.get(getAdapterPosition());
            ...
            final View view = inflater.inflate(R.layout.popup,null);
             ...
             babyItem.setText(newItem.getItamName());
             ...
             saveButton.setOnClickListener(new View.OnClickListener() {
                 ...
                 public void onClick(View v) {
                     ...
                     //update items
                     newItem.setItamName(babyItem.getText().toString());
