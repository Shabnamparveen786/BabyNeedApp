...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void addItem(Item item){
        ...
        values.put(Constants.KEY_BABY_ITEM, item.getItamName());
        ...
        Log.d("DBHandler","addedItem successfully: ");
    ...
    public Item getItem(int id){
        ...
        if(cursor != null){
            ...
            item.setItamName(cursor.getString(cursor.getColumnIndex(Constants.KEY_BABY_ITEM)));
